    ...
    <Header logoSrc="/nerdolalogo.png" links={footerLinks} />
        ...
        <main className="row-start-2 items-center sm:items-start w-full">
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">2270</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-yellow-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2"> 2244</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-purple-700 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                <h1>3º |</h1>
                <img src="https://static.significados.com.br/flags/kr.svg" width={100} height={50} alt="logo"/>
                <h3  className='text-xl font-bold '>Gen.G Esports</h3>
                <div className="bg-white p-2 rounded-lg text-black ml-2">2176</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-purple-400 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1890</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1636</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1288</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">984</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">924</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2"> 648</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">568</div>
            </div>
