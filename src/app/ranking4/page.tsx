    ...
    <header className="w-full p-5 flex flex-col items-center justify-center">
        ...
        <main className="row-start-2 items-center sm:items-start w-full">
            ...
            <div className="grid grid-cols-4 bg-purple-700 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <h3  className='text-xl font-bold '>M3C (Gambit)</h3>
                <div className="bg-white p-2 rounded-lg text-black ml-2">2420</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-purple-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">2080</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-yellow-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1984</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1604</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1426</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1312</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1230</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1036</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">730</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">616</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">608</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">590</div>
            </div>
