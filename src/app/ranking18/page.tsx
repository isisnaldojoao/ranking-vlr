    ...
    <header className="w-full p-5 flex flex-col items-center justify-center">
        ...
        <main className="row-start-2 items-center sm:items-start w-full">
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">2340</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-purple-700 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">2316</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-yellow-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                <h1>3º |</h1>
                <img src="https://static.significados.com.br/flags/cn.svg" width={100} height={50} alt="logo"/>
                <h3  className='text-xl font-bold '>EDward Gaming</h3>
                <div className="bg-white p-2 rounded-lg text-black ml-2">2278</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-purple-400 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1774</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1752</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1670</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1578</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1264</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">1122</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">978</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">856</div>
            </div>
            ...
            <div className="grid grid-cols-4 bg-gray-500 h-[100px] gap-4 m-5 flex items-center justify-center rounded-lg transition-all hover:scale-105 ">
                ...
                <div className="bg-white p-2 rounded-lg text-black ml-2">724</div>
            </div>
